...
class MajorProfessionalSpider(scrapy.Spider):
    name = 'major_professional'
    allowed_domains = ['yz.chsi.com.cn']
    start_urls = ['https://yz.chsi.com.cn/zyk/specialityCategory.do?method=subCategoryMl&key=20']
